...
//  val swrc = Namespace("http://swrc.ontoware.org/ontology#")
  val bibtex = Namespace("http://purl.org/net/nknouf/ns/bibtex#")
  ...
  msxml.documentInfo --> (
    ms.documentInfo > node(frag("documentInfo")) (
      ...
      objectMap(msxml.documentType, rdf_type,
        ...
        "other" -> bibtex.Misc),
      stringMap(msxml.title, bibtex.hasTitle),
      stringMap(msxml.author, bibtex.hasCreator),
      stringMap(msxml.editor, bibtex.hasEditor),
      yearMap(msxml.editor, bibtex.hasYear),
      stringMap(msxml.publisher, bibtex.hasPublisher),
      stringMap(msxml.bookTitle, bibtex.hasBooktitle),
      stringMap(msxml.journal, bibtex.hasJournal),
      stringMap(msxml.volume, bibtex.hasVolume),
      stringMap(msxml.series, bibtex.hasSeries),
      stringMap(msxml.pages, bibtex.hasPages),
      stringMap(msxml.edition, bibtex.hasEdition),
      stringMap(msxml.conference, ms.conference),
      stringMap(msxml.doi, ms.doi),
      linkMap(msxml.url, rdfs.seeAlso),
      stringMap(msxml.ISSN, ms.issn),
      stringMap(msxml.ISBN, bibtex.hasISBN),
      stringMap(msxml.keywords, bibtex.hasKeywords),
